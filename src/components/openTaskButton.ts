...
const fillColorForSVG =
  "var(--product-library-actionable-quaternary-idle-tint)";
const setupSvg = ({
  iconSvg,
  iconRect,
  iconLine,
  ...
  iconPath.setAttribute("fill", fillColorForSVG);
